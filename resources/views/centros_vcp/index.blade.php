    ...
    <div class="container-fluid col-12 text-right"style="color: rgb(136, 110, 110)">
      ...
      <div class="row align-items-center text-white p-4">
          ...
          <div class="col-4 text-right">
            ...
            <br>
            @can('crear-centro')
            <a class="linkText" href="/centros_vcp/create">Crear centro</a>
            <br>
            @endcan           
        </div>
      </div>
  ...
  <div class="card-body">
    ...
    <table id="table1" class="table table-striped table-hover"style="width:100%">
      <thead style="background-color:rgb(0, 46, 77)">                                     
          ...
          <th style="color:#fff;">Centros</th>                                    
          <th style="color:#fff;">
            @can('crear-centro')
            <a class="btn btn-sm btn-success text-light justify-content-md-end" href="{{ route('centros_vcp.create') }}"><i class="fas fa-lg fa-fw fa-plus-circle"></i>    Add</a>
            @endcan
          </th>                                                            
    </thead>
