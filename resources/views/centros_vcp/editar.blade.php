    ...
    <div class="container-fluid col-12 text-right"style="color: rgb(136, 110, 110)">
      ...
      <div class="row align-items-center text-white p-4">
          ...
          <div class="col-4 text-right">
            ...
            <form action="/centros_vcp/{{$centro->id}}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
<!--primera columna -->
                <div  class="col-xs-12 col-sm-12 col-md-4" style="border: lightgrey 1px solid;">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="codigo" class="form-control" value="{{ $centro->codigo }}" >
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                           <label for="codigo">Nombre de centro</label>
                           <input type="text" name="centro" class="form-control" value="{{ $centro->centro }}">
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <select class="form-control" id="sel1" name="provincia" required="" value="{{ $centro->provincia }}">
                        <option></option>
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <select class="form-control" id="sel1" name="distrito" required="" value="{{ $centro->distrito }}">
                        <option></option>
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <select class="form-control" id="sel1" name="corregimiento" required="" value="{{ $centro->corregimiento }}">
                        <option></option>
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="circuito" class="form-control" value="{{ $centro->circuito }}">
                    </div>
                </div>
            </div>
...
<!--segunda columna -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-4" style="border: lightgrey 1px solid;">
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="codigo_corregimiento" class="form-control" value="{{ $centro->codigo_corregimiento }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                       <label for="codigo">longitud</label>
                       <input type="text" name="geolon" class="form-control" value="{{ $centro->geolon }}">
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="form-group">
                   ...
                   <input type="text" name="geolat" class="form-control" value="{{ $centro->geolat}}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                   <label for="codigo">Despacho</label>
                   <input type="text" name="despacho" class="form-control" value="{{ $centro->despacho}}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                   <label for="codigo">Recepcion</label>
                   <input type="text" name="recepcion" class="form-control" value="{{ $centro->recepcion }}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                   <label for="codigo">Vacunacion</label>
                   <input type="text" name="vacunacion" class="form-control" value="{{ $centro->vacunacion }}">
                </div>
            </div>
...
<!--tercera columna -->
            <div class="col-xs-12 col-sm-12 col-md-4" style="border: lightgrey 1px solid;">
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="created_at" class="form-control" value="{{ $centro->created_at }}">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                       <label for="codigo">Actualizado</label>
                       <input type="text" name="updated_at" class="form-control" value="{{ $centro->updated_at}}">
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="form-group">
                   ...
                   <input type="text" name="borrado" class="form-control" value="{{ $centro->borrado }}">
                </div>
            </div>
            <br><br>
