    ...
    <div class="container-fluid col-12 text-right"style="color: rgb(136, 110, 110)">
      ...
      <div class="row align-items-center text-white p-4">
          ...
          <div class="col-4 text-center">
              ...
              <br>
              Crear Condicion Especial
          </div>
          <div class="col-4 text-right">
              <a class="linkText" href="../home">Home Dashboard</a>
              <br>
              <a class="linkText" href="/condiciones_especiales_vcp">Lista de Condicion Especial</a>
          </div>
      </div>
  </div>
</header>
...
<div class="section-body">
    <div  class="row">
        <div  class="col-lg-12">
            ...
            <form action="/condiciones_especiales_vcp" method="POST">
                @csrf
                <div class="">
                <div class="row">
<!--primera columna -->
