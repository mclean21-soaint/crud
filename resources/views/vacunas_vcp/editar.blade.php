    ...
    <div class="container-fluid col-12 text-right"style="color: rgb(136, 110, 110)">
      ...
      <div class="row align-items-center text-white p-4">
          ...
          <div class="col-4 text-right">
            ...
            <form action="/vacunas_vcp/{{$vacuna->id}}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
<!--primera columna -->
                <div  class="col-xs-4 col-sm-12 col-md-4" style="border: lightgrey 1px solid;">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="nombre" class="form-control" value="{{ $vacuna->nombre }}">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                           <label for="codigo">Codigo de vacuna</label>
                           <input type="text" name="codigo" class="form-control" value="{{ $vacuna->codigo }}">
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                       ...
                       <input type="text" name="tipo" class="form-control " value="{{ $vacuna->tipo }}">
                    </div>
                </div>
