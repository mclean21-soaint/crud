    ...
    <div class="container-fluid col-12 text-right"style="color: rgb(136, 110, 110)">
      ...
      <div class="row align-items-center text-white p-4">
          ...
          <div class="col-4 text-right">
              ...
              <br>
              <a class="linkText" href="/cronicos_vcp">Lista de Cronico</a>
          </div>
      </div>
  </div>
</header>
            ...
            <form action="/cronicos_vcp/{{$cronico->id}}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
<!--primera columna -->
                <div  class="col-xs-4 col-sm-12 col-md-4" style="border: lightgrey 1px solid;">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="nombre" class="form-control" value="{{ $cronico->nombre }}">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                           <label for="codigo">Codigo de cronico</label>
                           <input type="text" name="codigo" class="form-control" value="{{ $cronico->codigo }}">
                        </div>
                    </div>
                    <div class="text-right">
                        <button id="save" type="submit" class="btn btn-success"><i class="fas fa-save"></i>   Save</button>   
                        
                        <a href="/cronicos_vcp" class="btn btn-danger"><i class="fas fa-ban"></i>   Cancel</a>  
                      </div>
            </div>
